...
FOOTER: process.env.FOOTER === undefined ? '༺ֆքʟɛӼ ʀօɮօȶ༻ ᴘᴜʙʟɪᴄ ꜱᴛᴀʙʟᴇ' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ꜱᴘʟᴇx ʀᴏʙᴏᴛ*' : process.env.CAPTION,
